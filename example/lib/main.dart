...
class LogoPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final Pattern bgPattern = HorizontalStripesThick(
        bgColor: Colors.white, fgColor: Color(0xffd1cccc));
    ...
    bgPattern.paintOnCircle(
        ...
        customRect: Rect.fromLTWH(0, 0, 500, 500));
    ...
    path1.close();
    DiagonalStripesThick(bgColor: Color(0xff00154f), fgColor: Color(0xfff4af1b))
